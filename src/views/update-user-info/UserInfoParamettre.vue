<template>
  <v-card flat class="pa-3 mt-2" >
    ...
    <v-alert
      ...
      type="info"
    >
      <strong>Modifier vos informations personnel</strong>
    </v-alert>
    <v-card-text>
      <v-form class="multi-col-validation mt-6">
        <v-row>
            ...
            <v-card-text class="d-flex">
              ...
              <div>
                <v-btn color="primary" class="me-3 mt-5" @click="$refs.refInputEl.click()" >
                  ...
                  <span class="d-none d-sm-block">Charger une photo de profil</span>
                </v-btn>
          ...
          <v-divider></v-divider>
          <v-alert type="success">Vos informations personnel</v-alert>
        <v-spacer></v-spacer>
        <v-col
        cols="12"
        md="10"
              ...
              <div class="d-flex align-start">
                ...
                <div class="ms-3">
                  <p class="text-base font-weight-medium mb-1">
                    Vos informations seront visible par tout les acheteurs sur la platforme
                  </p>
                  <v-spacer></v-spacer>
