  ...
  setup() {
    const solidCardData = [
      ...
      },
      {
        ...
        title: 'Facebook Card',
        icon: mdiFacebook,
        text: 'You’ve read about the importance, rebellious and imaginative. These are all vital ingredients in an effective',
        avatarImg: '2.png',
      ...
      },
      {
        ...
        title: 'Linkedin Card',
        icon: mdiLinkedin,
        text: 'With the Internet spreading like wildfire every part of our daily life, more and more traffic is directed.',
        avatarImg: '1.png',
